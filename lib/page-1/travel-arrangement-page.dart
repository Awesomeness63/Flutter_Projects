        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              padding: EdgeInsets.fromLTRB(18*fem, 71*fem, 18*fem, 0*fem),
              width: double.infinity,
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 117*fem, 46*fem),
                    width: double.infinity,
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(21*fem, 0*fem, 26*fem, 11*fem),
                    width: double.infinity,
                    height: 50*fem,
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
            ...
            Container(
              ...
              padding: EdgeInsets.fromLTRB(23*fem, 31*fem, 24*fem, 39*fem),
              width: double.infinity,
              decoration: BoxDecoration (
