  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        ...
        padding: EdgeInsets.fromLTRB(19*fem, 71*fem, 9*fem, 40*fem),
        width: double.infinity,
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 136*fem, 34*fem),
              width: double.infinity,
              child: Row(
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(5*fem, 0*fem, 15*fem, 39*fem),
              padding: EdgeInsets.fromLTRB(12*fem, 25*fem, 12*fem, 18.67*fem),
              width: double.infinity,
              decoration: BoxDecoration (
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(5*fem, 0*fem, 0*fem, 39*fem),
              height: 219*fem,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  Container(
                    ...
                    padding: EdgeInsets.fromLTRB(29*fem, 18*fem, 29*fem, 16*fem),
                    width: 149*fem,
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          // ellipse296jpm (1:944)
                          margin: EdgeInsets.fromLTRB(18*fem, 0*fem, 17*fem, 13*fem),
                          width: double.infinity,
                          height: 56*fem,
                          decoration: BoxDecoration (
                        ...
                        Container(
                          ...
                          margin: EdgeInsets.fromLTRB(3.17*fem, 0*fem, 1*fem, 0*fem),
                          width: double.infinity,
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              Container(
                                // group1225vZ (1:946)
                                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 4.17*fem, 2*fem),
                                width: 11.67*fem,
                                height: 9.33*fem,
                                child: Image.asset(
                  ...
                  Container(
                    // group188LLh (1:943)
                    margin: EdgeInsets.fromLTRB(0*fem, 3*fem, 16.5*fem, 0*fem),
                    width: 21*fem,
                    height: 14*fem,
                    child: Image.asset(
                  ...
                  Container(
                    ...
                    padding: EdgeInsets.fromLTRB(27*fem, 18*fem, 26*fem, 16*fem),
                    width: 149*fem,
                    height: double.infinity,
                    decoration: BoxDecoration (
                      color: Color(0xfff4f4f4),
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          // ellipse297ZUM (1:945)
                          margin: EdgeInsets.fromLTRB(20*fem, 0*fem, 20*fem, 8*fem),
                          width: double.infinity,
                          height: 56*fem,
                          decoration: BoxDecoration (
                            borderRadius: BorderRadius.circular(28*fem),
                        ...
                        Container(
                          ...
                          margin: EdgeInsets.fromLTRB(9.17*fem, 0*fem, 0*fem, 0*fem),
                          width: double.infinity,
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    // group6928UQH (1:788)
                    margin: EdgeInsets.fromLTRB(0*fem, 13*fem, 8*fem, 13*fem),
                    height: double.infinity,
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(5*fem, 0*fem, 1*fem, 13*fem),
              width: double.infinity,
              height: 27*fem,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          // group6929yaZ (1:830)
                          margin: EdgeInsets.fromLTRB(0*fem, 13*fem, 8*fem, 12*fem),
                          height: double.infinity,
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    // group6930UJu (1:885)
                    margin: EdgeInsets.fromLTRB(0*fem, 13*fem, 4*fem, 13*fem),
                    height: double.infinity,
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
