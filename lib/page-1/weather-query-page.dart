        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              padding: EdgeInsets.fromLTRB(23*fem, 64*fem, 24*fem, 1*fem),
              width: double.infinity,
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 91*fem, 34*fem),
                    width: double.infinity,
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(22*fem, 0*fem, 12*fem, 15*fem),
                    width: double.infinity,
                    height: 50*fem,
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(140*fem, 0*fem, 139*fem, 0*fem),
                    width: double.infinity,
                    height: 3*fem,
                    decoration: BoxDecoration (
                      color: Color(0xff0373f3),
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    padding: EdgeInsets.fromLTRB(23*fem, 32*fem, 26*fem, 32*fem),
                    width: double.infinity,
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                ...
                                padding: EdgeInsets.fromLTRB(0*fem, 1*fem, 65*fem, 0*fem),
                                height: double.infinity,
                                child: Row(
                                  crossAxisAlignment: CrossAxisAlignment.center,
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      margin: EdgeInsets.fromLTRB(0*fem, 12*fem, 18*fem, 10*fem),
                                      width: 26*fem,
                                      height: double.infinity,
                                      child: Column(
                                        crossAxisAlignment: CrossAxisAlignment.center,
                  ...
                  Container(
                    // autogroupeq5p2py (QKwiQTgxozkc4WyBGneQ5P)
                    padding: EdgeInsets.fromLTRB(28*fem, 23*fem, 26*fem, 26*fem),
                    width: double.infinity,
                    height: 100*fem,
                    decoration: BoxDecoration (
                      color: Color(0xffffffff),
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          // autogroup6jrfWVF (QKwiZd6N2URhKvx4pe6JRf)
                          margin: EdgeInsets.fromLTRB(0*fem, 0.33*fem, 66*fem, 0*fem),
                          height: double.infinity,
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              Container(
                                ...
                                height: 23.33*fem,
                                child: Image.asset(
                                  'assets/page-1/images/group-125-aLH.png',
                                  width: 22.17*fem,
                                  height: 23.33*fem,
                                ),
                              ),
                        ...
                        Container(
                          // autogroupdqgvHeR (QKwifNRnc8soGRB5XBdqgV)
                          margin: EdgeInsets.fromLTRB(0*fem, 3*fem, 66*fem, 0*fem),
                          width: 31*fem,
                          height: 48*fem,
                          child: Stack(
                            children: [
                              Positioned(
                                ...
                                child: Align(
                                  child: SizedBox(
                                    ...
                                    height: 28*fem,
                                    child: Image.asset(
                                      'assets/page-1/images/carbon-map-1gM.png',
                                      width: 28*fem,
                                      height: 28*fem,
                                    ),
                                  ),
                        ...
                        Container(
                          // autogroupjn5wpXs (QKwimCbQUFwaoKLv9Gjn5w)
                          margin: EdgeInsets.fromLTRB(0*fem, 0.33*fem, 60*fem, 0*fem),
                          height: double.infinity,
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              Container(
                                ...
                                height: 23.33*fem,
                                child: Image.asset(
                                  'assets/page-1/images/group-123-5QV.png',
                                  width: 23.33*fem,
                                  height: 23.33*fem,
                                ),
                              ),
                        ...
                        Container(
                          // autogroupc7tuQW5 (QKwirhSFCYYdxZjT5Bc7tu)
                          height: double.infinity,
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              Container(
                                // vectorMgD (1:1482)
                                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 2.5*fem, 7.5*fem),
                                width: 22.5*fem,
                                height: 22.5*fem,
                                child: Image.asset(
                                  'assets/page-1/images/vector-HeR.png',
                                  width: 22.5*fem,
                                  height: 22.5*fem,
                                ),
                              ),
