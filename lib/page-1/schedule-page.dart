          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                margin:
                    EdgeInsets.fromLTRB(0 * fem, 0 * fem, 131 * fem, 31 * fem),
                width: double.infinity,
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Container(
                      ...
                      margin: EdgeInsets.fromLTRB(
                          0 * fem, 0 * fem, 75 * fem, 1 * fem),
                      child: TextButton(
                        onPressed: () {
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(builder: (context) => AttrInfo()),
                          );
                        },
              ...
              Container(
                ...
                margin:
                    EdgeInsets.fromLTRB(4 * fem, 0 * fem, 0 * fem, 35 * fem),
                padding:
                    EdgeInsets.fromLTRB(10 * fem, 50 * fem, 10 * fem, 3 * fem),
                width: 356 * fem,
                decoration: BoxDecoration(
              ...
              Container(
                ...
                margin:
                    EdgeInsets.fromLTRB(4.21 * fem, 0 * fem, 0 * fem, 21 * fem),
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Container(
              ...
              Container(
                ...
                margin:
                    EdgeInsets.fromLTRB(6 * fem, 0 * fem, 3 * fem, 16 * fem),
                width: double.infinity,
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
              ...
              Container(
                ...
                margin:
                    EdgeInsets.fromLTRB(122 * fem, 0 * fem, 0 * fem, 22 * fem),
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Container(
              ...
              Container(
                ...
                margin:
                    EdgeInsets.fromLTRB(17 * fem, 0 * fem, 10 * fem, 23 * fem),
                width: double.infinity,
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
              ...
              Container(
                ...
                margin:
                    EdgeInsets.fromLTRB(15 * fem, 0 * fem, 9 * fem, 16 * fem),
                width: double.infinity,
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
              ...
              Container(
                ...
                margin:
                    EdgeInsets.fromLTRB(13 * fem, 0 * fem, 7 * fem, 18 * fem),
                width: double.infinity,
                height: 34 * fem,
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.center,
              ...
              Container(
                ...
                margin:
                    EdgeInsets.fromLTRB(0 * fem, 0 * fem, 146 * fem, 37 * fem),
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Container(
              ...
              Container(
                ...
                margin:
                    EdgeInsets.fromLTRB(0 * fem, 0 * fem, 247 * fem, 8 * fem),
                child: Text(
                  'Select dates',
                  style: SafeGoogleFont(
                    'Poppins',
              ...
              Container(
                ...
                margin:
                    EdgeInsets.fromLTRB(6 * fem, 0 * fem, 0 * fem, 31 * fem),
                width: double.infinity,
                height: 52 * fem,
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Container(
                      ...
                      margin: EdgeInsets.fromLTRB(
                          0 * fem, 1 * fem, 23 * fem, 1 * fem),
                      padding: EdgeInsets.fromLTRB(
                          20.75 * fem, 12 * fem, 116 * fem, 14 * fem),
                      height: double.infinity,
                      decoration: BoxDecoration(
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            // group58JBs (1:630)
                            margin: EdgeInsets.fromLTRB(
                                0 * fem, 2.06 * fem, 13.75 * fem, 0 * fem),
                            width: 18.5 * fem,
                            height: 17.56 * fem,
                            child: Image.asset(
              ...
              Container(
                ...
                margin:
                    EdgeInsets.fromLTRB(6 * fem, 0 * fem, 1 * fem, 34 * fem),
                width: double.infinity,
                height: 33 * fem,
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.center,
              ...
              Container(
                ...
                child: GestureDetector(
                  onTap: () {
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(builder: (context) => TravelActivity()),
                    );
                  },
                  child: Center(
                    child: Text(
